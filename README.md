...
- STEP1. 设置表头信息（平台、店铺、负责人等）
- STEP2. 商品与尺码库管理
- STEP3. 备货清单编辑（按尺码填写数量）
- STEP4. 页组与排序（每页组 12 格，支持对调）
- 打印预览（A4 横版）
- 导出 PDF
...
1. **STEP1.** 在「设置表头信息」填写平台、店铺、负责人、发货方式、日期。  
2. **STEP2.** 在「商品与尺码库」维护商品模板。  
3. **STEP3.** 在「备货清单编辑」将商品加入清单并填写数量。  
4. **STEP4.** 在「页组与排序」分配页组与版面 1–12 格（冲突时可选择对调）。  
5. 切到「预览模式」核对版式与数据。  
6. 使用「导出 PDF」或「一键存档」。  
